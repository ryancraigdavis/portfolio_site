  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `url("img/banner/beach.jpg")`,
        }}
      >
          ...
          <div className="row align-items-center full-screen">
            <div className="col-lg-12">
              <div className="hb-typo text-center">
                <Fade bottom>
                  <h6>I'm</h6>
                  <h1 className="font-alt">Ryan Davis</h1>
                  <h2>
                    <TextLoop>
                      <span className="loop-text">Software Engineer</span>
                      <span className="loop-text">Sushi Chef</span>
                      <span className="loop-text">Professor</span>
                    </TextLoop>{" "}
                  </h2>
                </Fade>
              </div>
